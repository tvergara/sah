...
# sbatch --gres=gpu:h100:4 --time=24:00:00 --mem=240G --export=ALL,NCCL_P2P_DISABLE=1 slurm/run-experiment.sh olmo3-32b-step656k metamath lora seed=1 algorithm.strategy.lr=0.0001 algorithm.strategy.ft_strategy=qlora algorithm.batch_size=2 trainer.strategy=ddp trainer.devices=4

...
for seed in "${SEEDS[@]}"; do
  for lr in "${LR_ONLINE_CODING[@]}"; do
    for max_ex in "${MAX_EXAMPLES[@]}"; do
      ...
      sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh smollm3 metamath online-coding seed=$seed algorithm.strategy.lr=$lr algorithm.max_examples=$max_ex
    done
  done
done
...
# sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh smollm3 metamath urial seed=1

# # SmolLM3 + MetaMath + Baseline
# echo "SmolLM3 + MetaMath (baseline)"
# sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh smollm3 metamath baseline seed=1
...
#       sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh smollm3 flores online-coding seed=$seed algorithm.strategy.lr=$lr algorithm.max_examples=$max_ex
#     done
#   done
# done
...
# sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh smollm3 flores urial seed=1

# # SmolLM3 + FLORES + Baseline
# echo "SmolLM3 + FLORES (baseline)"
# sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh smollm3 flores baseline seed=1
...
for seed in "${SEEDS[@]}"; do
  for lr in "${LR_ONLINE_CODING[@]}"; do
    for max_ex in "${MAX_EXAMPLES[@]}"; do
      ...
      sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh smollm3 ifeval online-coding seed=$seed algorithm.strategy.lr=$lr algorithm.max_examples=$max_ex
    done
  done
done
...
#   sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh smollm3 ifeval icl algorithm.batch_size=1 seed=$seed
# done

# # SmolLM3 + IFEval + URIAL
# echo "SmolLM3 + IFEval (urial)"
# sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh smollm3 ifeval urial seed=1

# # SmolLM3 + IFEval + Baseline
# echo "SmolLM3 + IFEval (baseline)"
# sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh smollm3 ifeval baseline seed=1
...
for seed in "${SEEDS[@]}"; do
  for lr in "${LR_ONLINE_CODING[@]}"; do
    for max_ex in "${MAX_EXAMPLES[@]}"; do
      ...
      sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh smollm3-step40k metamath online-coding seed=$seed algorithm.strategy.lr=$lr algorithm.max_examples=$max_ex
    done
  done
done
...
#   sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh smollm3-step40k metamath icl algorithm.batch_size=1 seed=$seed
# done

# SmolLM3-Step40k + MetaMath + URIAL
# echo "SmolLM3-Step40k + MetaMath (urial)"
# sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh smollm3-step40k metamath urial seed=1

# # SmolLM3-Step40k + MetaMath + Baseline
# echo "SmolLM3-Step40k + MetaMath (baseline)"
# sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh smollm3-step40k metamath baseline seed=1
...
#       sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh smollm3-step40k flores online-coding seed=$seed algorithm.strategy.lr=$lr algorithm.max_examples=$max_ex
#     done
#   done
# done
...
#   sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh smollm3-step40k flores icl algorithm.batch_size=1 seed=$seed
# done

# # SmolLM3-Step40k + FLORES + URIAL
# echo "SmolLM3-Step40k + FLORES (urial)"
# sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh smollm3-step40k flores urial seed=1

# # SmolLM3-Step40k + FLORES + Baseline
# echo "SmolLM3-Step40k + FLORES (baseline)"
# sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh smollm3-step40k flores baseline seed=1
...
for seed in "${SEEDS[@]}"; do
  for lr in "${LR_ONLINE_CODING[@]}"; do
    for max_ex in "${MAX_EXAMPLES[@]}"; do
      ...
      sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh smollm3-step40k ifeval online-coding seed=$seed algorithm.strategy.lr=$lr algorithm.max_examples=$max_ex
    done
  done
done
...
#   sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh smollm3-step40k ifeval icl algorithm.batch_size=1 seed=$seed
# done

# # SmolLM3-Step40k + IFEval + URIAL
# echo "SmolLM3-Step40k + IFEval (urial)"
# sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh smollm3-step40k ifeval urial seed=1

# # SmolLM3-Step40k + IFEval + Baseline
# echo "SmolLM3-Step40k + IFEval (baseline)"
# sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh smollm3-step40k ifeval baseline seed=1
...
for seed in "${SEEDS[@]}"; do
  for lr in "${LR_ONLINE_CODING[@]}"; do
    for max_ex in "${MAX_EXAMPLES[@]}"; do
      ...
      sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh smollm3-step1720k metamath online-coding seed=$seed algorithm.strategy.lr=$lr algorithm.max_examples=$max_ex
    done
  done
done
...
#   sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh smollm3-step1720k metamath icl algorithm.batch_size=1 seed=$seed
# done

# # SmolLM3-Step1720k + MetaMath + URIAL
# echo "SmolLM3-Step1720k + MetaMath (urial)"
# sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh smollm3-step1720k metamath urial seed=1

# # SmolLM3-Step1720k + MetaMath + Baseline
# echo "SmolLM3-Step1720k + MetaMath (baseline)"
# sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh smollm3-step1720k metamath baseline seed=1
...
#       sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh smollm3-step1720k flores online-coding seed=$seed algorithm.strategy.lr=$lr algorithm.max_examples=$max_ex
#     done
#   done
# done
...
#   sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh smollm3-step1720k flores icl algorithm.batch_size=1 seed=$seed
# done

# # SmolLM3-Step1720k + FLORES + URIAL
# echo "SmolLM3-Step1720k + FLORES (urial)"
# sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh smollm3-step1720k flores urial seed=1

# # SmolLM3-Step1720k + FLORES + Baseline
# echo "SmolLM3-Step1720k + FLORES (baseline)"
# sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh smollm3-step1720k flores baseline seed=1
...
for seed in "${SEEDS[@]}"; do
  for lr in "${LR_ONLINE_CODING[@]}"; do
    for max_ex in "${MAX_EXAMPLES[@]}"; do
      ...
      sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh smollm3-step1720k ifeval online-coding seed=$seed algorithm.strategy.lr=$lr algorithm.max_examples=$max_ex
    done
  done
done
...
#   sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh smollm3-step1720k ifeval icl algorithm.batch_size=1 seed=$seed
# done

# # SmolLM3-Step1720k + IFEval + URIAL
# echo "SmolLM3-Step1720k + IFEval (urial)"
# sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh smollm3-step1720k ifeval urial seed=1

# # SmolLM3-Step1720k + IFEval + Baseline
# echo "SmolLM3-Step1720k + IFEval (baseline)"
# sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh smollm3-step1720k ifeval baseline seed=1
...
for seed in "${SEEDS[@]}"; do
  for lr in "${LR_ONLINE_CODING[@]}"; do
    for max_ex in "${MAX_EXAMPLES[@]}"; do
      ...
      sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh smollm3-stage2 metamath online-coding seed=$seed algorithm.strategy.lr=$lr algorithm.max_examples=$max_ex
    done
  done
done
...
# sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh smollm3-stage2 metamath urial seed=1

# # SmolLM3-Stage2 + MetaMath + Baseline
# echo "SmolLM3-Stage2 + MetaMath (baseline)"
# sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh smollm3-stage2 metamath baseline seed=1
...
#       sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh smollm3-stage2 flores online-coding seed=$seed algorithm.strategy.lr=$lr algorithm.max_examples=$max_ex
#     done
#   done
# done
...
# sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh smollm3-stage2 flores urial seed=1

# # SmolLM3-Stage2 + FLORES + Baseline
# echo "SmolLM3-Stage2 + FLORES (baseline)"
# sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh smollm3-stage2 flores baseline seed=1
...
for seed in "${SEEDS[@]}"; do
  for lr in "${LR_ONLINE_CODING[@]}"; do
    for max_ex in "${MAX_EXAMPLES[@]}"; do
      ...
      sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh smollm3-stage2 ifeval online-coding seed=$seed algorithm.strategy.lr=$lr algorithm.max_examples=$max_ex
    done
  done
done
...
#   sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh smollm3-stage2 ifeval icl algorithm.batch_size=1 seed=$seed
# done

# # SmolLM3-Stage2 + IFEval + URIAL
# echo "SmolLM3-Stage2 + IFEval (urial)"
# sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh smollm3-stage2 ifeval urial seed=1

# # SmolLM3-Stage2 + IFEval + Baseline
# echo "SmolLM3-Stage2 + IFEval (baseline)"
# sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh smollm3-stage2 ifeval baseline seed=1
...
for seed in "${SEEDS[@]}"; do
  for lr in "${LR_ONLINE_CODING[@]}"; do
    for max_ex in "${MAX_EXAMPLES[@]}"; do
      ...
      sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh smollm3-stage3 metamath online-coding seed=$seed algorithm.strategy.lr=$lr algorithm.max_examples=$max_ex
    done
  done
done
...
# sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh smollm3-stage3 metamath urial seed=1

# # SmolLM3-Stage3 + MetaMath + Baseline
# echo "SmolLM3-Stage3 + MetaMath (baseline)"
# sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh smollm3-stage3 metamath baseline seed=1
...
#       sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh smollm3-stage3 flores online-coding seed=$seed algorithm.strategy.lr=$lr algorithm.max_examples=$max_ex
#     done
#   done
# done
...
# sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh smollm3-stage3 flores urial seed=1

# # SmolLM3-Stage3 + FLORES + Baseline
# echo "SmolLM3-Stage3 + FLORES (baseline)"
# sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh smollm3-stage3 flores baseline seed=1
...
for seed in "${SEEDS[@]}"; do
  for lr in "${LR_ONLINE_CODING[@]}"; do
    for max_ex in "${MAX_EXAMPLES[@]}"; do
      ...
      sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh smollm3-stage3 ifeval online-coding seed=$seed algorithm.strategy.lr=$lr algorithm.max_examples=$max_ex
    done
  done
done
...
#   sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh smollm3-stage3 ifeval icl algorithm.batch_size=1 seed=$seed
# done

# # SmolLM3-Stage3 + IFEval + URIAL
# echo "SmolLM3-Stage3 + IFEval (urial)"
# sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh smollm3-stage3 ifeval urial seed=1

# # SmolLM3-Stage3 + IFEval + Baseline
# echo "SmolLM3-Stage3 + IFEval (baseline)"
# sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh smollm3-stage3 ifeval baseline seed=1
...
# sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh olmo3-7b-step0 metamath urial seed=1

# # OLMo3-7B-Step0 + MetaMath + Baseline
# echo "OLMo3-7B-Step0 + MetaMath (baseline)"
# sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh olmo3-7b-step0 metamath baseline seed=1
...
# sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh olmo3-7b-step0 flores urial seed=1

# # OLMo3-7B-Step0 + FLORES + Baseline
# echo "OLMo3-7B-Step0 + FLORES (baseline)"
# sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh olmo3-7b-step0 flores baseline seed=1
...
# sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh olmo3-7b-step0 ifeval urial seed=1

# # OLMo3-7B-Step0 + IFEval + Baseline
# echo "OLMo3-7B-Step0 + IFEval (baseline)"
# sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh olmo3-7b-step0 ifeval baseline seed=1
...
# sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh olmo3-7b-step707k metamath urial seed=1

# # OLMo3-7B-Step707k + MetaMath + Baseline
# echo "OLMo3-7B-Step707k + MetaMath (baseline)"
# sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh olmo3-7b-step707k metamath baseline seed=1
...
# sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh olmo3-7b-step707k flores urial seed=1

# # OLMo3-7B-Step707k + FLORES + Baseline
# echo "OLMo3-7B-Step707k + FLORES (baseline)"
# sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh olmo3-7b-step707k flores baseline seed=1
...
# sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh olmo3-7b-step707k ifeval urial seed=1

# # OLMo3-7B-Step707k + IFEval + Baseline
# echo "OLMo3-7B-Step707k + IFEval (baseline)"
# sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh olmo3-7b-step707k ifeval baseline seed=1
...
# sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh olmo3-7b-stage2-step6k metamath urial seed=1

# # OLMo3-7B-Stage2-Step6k + MetaMath + Baseline
# echo "OLMo3-7B-Stage2-Step6k + MetaMath (baseline)"
# sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh olmo3-7b-stage2-step6k metamath baseline seed=1
...
# sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh olmo3-7b-stage2-step6k flores urial seed=1

# # OLMo3-7B-Stage2-Step6k + FLORES + Baseline
# echo "OLMo3-7B-Stage2-Step6k + FLORES (baseline)"
# sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh olmo3-7b-stage2-step6k flores baseline seed=1
...
# sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh olmo3-7b-stage2-step6k ifeval urial seed=1

# # OLMo3-7B-Stage2-Step6k + IFEval + Baseline
# echo "OLMo3-7B-Stage2-Step6k + IFEval (baseline)"
# sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh olmo3-7b-stage2-step6k ifeval baseline seed=1
...
# sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh olmo3-7b-stage2-step12k metamath urial seed=1

# # OLMo3-7B-Stage2-Step12k + MetaMath + Baseline
# echo "OLMo3-7B-Stage2-Step12k + MetaMath (baseline)"
# sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh olmo3-7b-stage2-step12k metamath baseline seed=1
...
# sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh olmo3-7b-stage2-step12k flores urial seed=1

# # OLMo3-7B-Stage2-Step12k + FLORES + Baseline
# echo "OLMo3-7B-Stage2-Step12k + FLORES (baseline)"
# sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh olmo3-7b-stage2-step12k flores baseline seed=1
...
# sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh olmo3-7b-stage2-step12k ifeval urial seed=1

# # OLMo3-7B-Stage2-Step12k + IFEval + Baseline
# echo "OLMo3-7B-Stage2-Step12k + IFEval (baseline)"
# sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh olmo3-7b-stage2-step12k ifeval baseline seed=1
...
# sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh olmo3-7b-stage2-step24k metamath urial seed=1

# # OLMo3-7B-Stage2-Step24k + MetaMath + Baseline
# echo "OLMo3-7B-Stage2-Step24k + MetaMath (baseline)"
# sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh olmo3-7b-stage2-step24k metamath baseline seed=1
...
# sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh olmo3-7b-stage2-step24k flores urial seed=1

# # OLMo3-7B-Stage2-Step24k + FLORES + Baseline
# echo "OLMo3-7B-Stage2-Step24k + FLORES (baseline)"
# sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh olmo3-7b-stage2-step24k flores baseline seed=1
...
# sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh olmo3-7b-stage2-step24k ifeval urial seed=1

# # OLMo3-7B-Stage2-Step24k + IFEval + Baseline
# echo "OLMo3-7B-Stage2-Step24k + IFEval (baseline)"
# sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh olmo3-7b-stage2-step24k ifeval baseline seed=1
...
# sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh olmo3-7b-stage2-step48k metamath urial seed=1

# # OLMo3-7B-Stage2-Step48k + MetaMath + Baseline
# echo "OLMo3-7B-Stage2-Step48k + MetaMath (baseline)"
# sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh olmo3-7b-stage2-step48k metamath baseline seed=1
...
# sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh olmo3-7b-stage2-step48k flores urial seed=1

# # OLMo3-7B-Stage2-Step48k + FLORES + Baseline
# echo "OLMo3-7B-Stage2-Step48k + FLORES (baseline)"
# sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh olmo3-7b-stage2-step48k flores baseline seed=1
...
# sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh olmo3-7b-stage2-step48k ifeval urial seed=1

# # OLMo3-7B-Stage2-Step48k + IFEval + Baseline
# echo "OLMo3-7B-Stage2-Step48k + IFEval (baseline)"
# sbatch --gres=gpu:a100l:1 slurm/run-experiment.sh olmo3-7b-stage2-step48k ifeval baseline seed=1

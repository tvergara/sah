...
# sbatch --gres=gpu:1 slurm/run-experiment.sh smollm3 metamath urial seed=1

# # SmolLM3 + MetaMath + Baseline
# echo "SmolLM3 + MetaMath (baseline)"
# sbatch --gres=gpu:1 slurm/run-experiment.sh smollm3 metamath baseline seed=1
...
# sbatch --gres=gpu:1 slurm/run-experiment.sh smollm3 flores urial seed=1
...
for max_ex in "${MAX_EXAMPLES[@]}"; do
  ...
  sbatch --gres=gpu:1 slurm/run-experiment.sh smollm3 ifeval online-coding seed=1 algorithm.strategy.lr=1e-4 algorithm.max_examples=$max_ex
done

for max_ex in "${MAX_EXAMPLES[@]}"; do
  echo "SmolLM3 + IFEval (online-coding, seed=1, lr=1e-5, max_examples=$max_ex)"
  sbatch --gres=gpu:1 slurm/run-experiment.sh smollm3 ifeval online-coding seed=1 algorithm.strategy.lr=1e-5 algorithm.max_examples=$max_ex
done
...
# sbatch --gres=gpu:1 slurm/run-experiment.sh smollm3-step40k metamath urial seed=1

# # SmolLM3-Step40k + MetaMath + Baseline
# echo "SmolLM3-Step40k + MetaMath (baseline)"
# sbatch --gres=gpu:1 slurm/run-experiment.sh smollm3-step40k metamath baseline seed=1
...
# sbatch --gres=gpu:1 slurm/run-experiment.sh smollm3-step40k flores urial seed=1
...
for max_ex in "${MAX_EXAMPLES[@]}"; do
  ...
  sbatch --gres=gpu:1 slurm/run-experiment.sh smollm3-step40k ifeval online-coding seed=1 algorithm.strategy.lr=1e-4 algorithm.max_examples=$max_ex
done

for max_ex in "${MAX_EXAMPLES[@]}"; do
  echo "SmolLM3-Step40k + IFEval (online-coding, seed=1, lr=1e-5, max_examples=$max_ex)"
  sbatch --gres=gpu:1 slurm/run-experiment.sh smollm3-step40k ifeval online-coding seed=1 algorithm.strategy.lr=1e-5 algorithm.max_examples=$max_ex
done
...
# sbatch --gres=gpu:1 slurm/run-experiment.sh smollm3-step1720k metamath urial seed=1

# # SmolLM3-Step1720k + MetaMath + Baseline
# echo "SmolLM3-Step1720k + MetaMath (baseline)"
# sbatch --gres=gpu:1 slurm/run-experiment.sh smollm3-step1720k metamath baseline seed=1
...
# sbatch --gres=gpu:1 slurm/run-experiment.sh smollm3-step1720k flores urial seed=1
...
for max_ex in "${MAX_EXAMPLES[@]}"; do
  ...
  sbatch --gres=gpu:1 slurm/run-experiment.sh smollm3-step1720k ifeval online-coding seed=1 algorithm.strategy.lr=1e-4 algorithm.max_examples=$max_ex
done

for max_ex in "${MAX_EXAMPLES[@]}"; do
  echo "SmolLM3-Step1720k + IFEval (online-coding, seed=1, lr=1e-5, max_examples=$max_ex)"
  sbatch --gres=gpu:1 slurm/run-experiment.sh smollm3-step1720k ifeval online-coding seed=1 algorithm.strategy.lr=1e-5 algorithm.max_examples=$max_ex
done
...
# sbatch --gres=gpu:1 slurm/run-experiment.sh smollm3-stage2 metamath urial seed=1

# # SmolLM3-Stage2 + MetaMath + Baseline
# echo "SmolLM3-Stage2 + MetaMath (baseline)"
# sbatch --gres=gpu:1 slurm/run-experiment.sh smollm3-stage2 metamath baseline seed=1
...
# sbatch --gres=gpu:1 slurm/run-experiment.sh smollm3-stage2 flores urial seed=1
...
for max_ex in "${MAX_EXAMPLES[@]}"; do
  ...
  sbatch --gres=gpu:1 slurm/run-experiment.sh smollm3-stage2 ifeval online-coding seed=1 algorithm.strategy.lr=1e-4 algorithm.max_examples=$max_ex
done

for max_ex in "${MAX_EXAMPLES[@]}"; do
  echo "SmolLM3-Stage2 + IFEval (online-coding, seed=1, lr=1e-5, max_examples=$max_ex)"
  sbatch --gres=gpu:1 slurm/run-experiment.sh smollm3-stage2 ifeval online-coding seed=1 algorithm.strategy.lr=1e-5 algorithm.max_examples=$max_ex
done
...
# sbatch --gres=gpu:1 slurm/run-experiment.sh smollm3-stage3 metamath urial seed=1

# # SmolLM3-Stage3 + MetaMath + Baseline
# echo "SmolLM3-Stage3 + MetaMath (baseline)"
# sbatch --gres=gpu:1 slurm/run-experiment.sh smollm3-stage3 metamath baseline seed=1
...
# sbatch --gres=gpu:1 slurm/run-experiment.sh smollm3-stage3 flores urial seed=1
...
for max_ex in "${MAX_EXAMPLES[@]}"; do
  ...
  sbatch --gres=gpu:1 slurm/run-experiment.sh smollm3-stage3 ifeval online-coding seed=1 algorithm.strategy.lr=1e-4 algorithm.max_examples=$max_ex
done

for max_ex in "${MAX_EXAMPLES[@]}"; do
  echo "SmolLM3-Stage3 + IFEval (online-coding, seed=1, lr=1e-5, max_examples=$max_ex)"
  sbatch --gres=gpu:1 slurm/run-experiment.sh smollm3-stage3 ifeval online-coding seed=1 algorithm.strategy.lr=1e-5 algorithm.max_examples=$max_ex
done
...
#       sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-step0 metamath online-coding seed=$seed algorithm.strategy.lr=$lr algorithm.max_examples=$max_ex
#     done
#   done
# done
...
#   sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-step0 metamath icl algorithm.batch_size=1 seed=$seed
# done

# # OLMo3-7B-Step0 + MetaMath + URIAL
# echo "OLMo3-7B-Step0 + MetaMath (urial)"
# sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-step0 metamath urial seed=1

# # OLMo3-7B-Step0 + MetaMath + Baseline
# echo "OLMo3-7B-Step0 + MetaMath (baseline)"
# sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-step0 metamath baseline seed=1
...
#       sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-step0 flores online-coding seed=$seed algorithm.strategy.lr=$lr algorithm.max_examples=$max_ex
#     done
#   done
# done
...
#   sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-step0 flores icl algorithm.batch_size=1 seed=$seed
# done

# # OLMo3-7B-Step0 + FLORES + URIAL
# echo "OLMo3-7B-Step0 + FLORES (urial)"
# sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-step0 flores urial seed=1
...
for max_ex in "${MAX_EXAMPLES[@]}"; do
  ...
  sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-step0 ifeval online-coding seed=1 algorithm.strategy.lr=1e-4 algorithm.max_examples=$max_ex
done

for max_ex in "${MAX_EXAMPLES[@]}"; do
  echo "OLMo3-7B-Step0 + IFEval (online-coding, seed=1, lr=1e-5, max_examples=$max_ex)"
  sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-step0 ifeval online-coding seed=1 algorithm.strategy.lr=1e-5 algorithm.max_examples=$max_ex
done

# OLMo3-7B-Step0 + IFEval + ICL
echo "OLMo3-7B-Step0 + IFEval (icl, seed=1)"
sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-step0 ifeval icl algorithm.batch_size=1 seed=1
...
#       sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-step707k metamath online-coding seed=$seed algorithm.strategy.lr=$lr algorithm.max_examples=$max_ex
#     done
#   done
# done
...
#   sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-step707k metamath icl algorithm.batch_size=1 seed=$seed
# done

# # OLMo3-7B-Step707k + MetaMath + URIAL
# echo "OLMo3-7B-Step707k + MetaMath (urial)"
# sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-step707k metamath urial seed=1

# # OLMo3-7B-Step707k + MetaMath + Baseline
# echo "OLMo3-7B-Step707k + MetaMath (baseline)"
# sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-step707k metamath baseline seed=1
...
#       sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-step707k flores online-coding seed=$seed algorithm.strategy.lr=$lr algorithm.max_examples=$max_ex
#     done
#   done
# done
...
#   sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-step707k flores icl algorithm.batch_size=1 seed=$seed
# done

# # OLMo3-7B-Step707k + FLORES + URIAL
# echo "OLMo3-7B-Step707k + FLORES (urial)"
# sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-step707k flores urial seed=1
...
for max_ex in "${MAX_EXAMPLES[@]}"; do
  ...
  sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-step707k ifeval online-coding seed=1 algorithm.strategy.lr=1e-4 algorithm.max_examples=$max_ex
done

for max_ex in "${MAX_EXAMPLES[@]}"; do
  echo "OLMo3-7B-Step707k + IFEval (online-coding, seed=1, lr=1e-5, max_examples=$max_ex)"
  sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-step707k ifeval online-coding seed=1 algorithm.strategy.lr=1e-5 algorithm.max_examples=$max_ex
done
...
#       sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-stage2-step6k metamath online-coding seed=$seed algorithm.strategy.lr=$lr algorithm.max_examples=$max_ex
#     done
#   done
# done
...
#   sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-stage2-step6k metamath icl algorithm.batch_size=1 seed=$seed
# done

# # OLMo3-7B-Stage2-Step6k + MetaMath + URIAL
# echo "OLMo3-7B-Stage2-Step6k + MetaMath (urial)"
# sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-stage2-step6k metamath urial seed=1

# # OLMo3-7B-Stage2-Step6k + MetaMath + Baseline
# echo "OLMo3-7B-Stage2-Step6k + MetaMath (baseline)"
# sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-stage2-step6k metamath baseline seed=1
...
#       sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-stage2-step6k flores online-coding seed=$seed algorithm.strategy.lr=$lr algorithm.max_examples=$max_ex
#     done
#   done
# done
...
#   sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-stage2-step6k flores icl algorithm.batch_size=1 seed=$seed
# done

# # OLMo3-7B-Stage2-Step6k + FLORES + URIAL
# echo "OLMo3-7B-Stage2-Step6k + FLORES (urial)"
# sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-stage2-step6k flores urial seed=1
...
for max_ex in "${MAX_EXAMPLES[@]}"; do
  ...
  sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-stage2-step6k ifeval online-coding seed=1 algorithm.strategy.lr=1e-4 algorithm.max_examples=$max_ex
done

for max_ex in "${MAX_EXAMPLES[@]}"; do
  echo "OLMo3-7B-Stage2-Step6k + IFEval (online-coding, seed=1, lr=1e-5, max_examples=$max_ex)"
  sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-stage2-step6k ifeval online-coding seed=1 algorithm.strategy.lr=1e-5 algorithm.max_examples=$max_ex
done

# OLMo3-7B-Stage2-Step6k + IFEval + ICL
echo "OLMo3-7B-Stage2-Step6k + IFEval (icl, seed=1)"
sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-stage2-step6k ifeval icl algorithm.batch_size=1 seed=1
...
#       sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-stage2-step12k metamath online-coding seed=$seed algorithm.strategy.lr=$lr algorithm.max_examples=$max_ex
#     done
#   done
# done
...
#   sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-stage2-step12k metamath icl algorithm.batch_size=1 seed=$seed
# done

# # OLMo3-7B-Stage2-Step12k + MetaMath + URIAL
# echo "OLMo3-7B-Stage2-Step12k + MetaMath (urial)"
# sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-stage2-step12k metamath urial seed=1

# # OLMo3-7B-Stage2-Step12k + MetaMath + Baseline
# echo "OLMo3-7B-Stage2-Step12k + MetaMath (baseline)"
# sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-stage2-step12k metamath baseline seed=1
...
#       sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-stage2-step12k flores online-coding seed=$seed algorithm.strategy.lr=$lr algorithm.max_examples=$max_ex
#     done
#   done
# done
...
#   sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-stage2-step12k flores icl algorithm.batch_size=1 seed=$seed
# done

# # OLMo3-7B-Stage2-Step12k + FLORES + URIAL
# echo "OLMo3-7B-Stage2-Step12k + FLORES (urial)"
# sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-stage2-step12k flores urial seed=1
...
for max_ex in "${MAX_EXAMPLES[@]}"; do
  ...
  sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-stage2-step12k ifeval online-coding seed=1 algorithm.strategy.lr=1e-4 algorithm.max_examples=$max_ex
done

for max_ex in "${MAX_EXAMPLES[@]}"; do
  echo "OLMo3-7B-Stage2-Step12k + IFEval (online-coding, seed=1, lr=1e-5, max_examples=$max_ex)"
  sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-stage2-step12k ifeval online-coding seed=1 algorithm.strategy.lr=1e-5 algorithm.max_examples=$max_ex
done
...
#       sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-stage2-step24k metamath online-coding seed=$seed algorithm.strategy.lr=$lr algorithm.max_examples=$max_ex
#     done
#   done
# done
...
#   sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-stage2-step24k metamath icl algorithm.batch_size=1 seed=$seed
# done

# # OLMo3-7B-Stage2-Step24k + MetaMath + URIAL
# echo "OLMo3-7B-Stage2-Step24k + MetaMath (urial)"
# sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-stage2-step24k metamath urial seed=1

# # OLMo3-7B-Stage2-Step24k + MetaMath + Baseline
# echo "OLMo3-7B-Stage2-Step24k + MetaMath (baseline)"
# sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-stage2-step24k metamath baseline seed=1
...
#       sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-stage2-step24k flores online-coding seed=$seed algorithm.strategy.lr=$lr algorithm.max_examples=$max_ex
#     done
#   done
# done
...
#   sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-stage2-step24k flores icl algorithm.batch_size=1 seed=$seed
# done

# # OLMo3-7B-Stage2-Step24k + FLORES + URIAL
# echo "OLMo3-7B-Stage2-Step24k + FLORES (urial)"
# sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-stage2-step24k flores urial seed=1
...
for max_ex in "${MAX_EXAMPLES[@]}"; do
  ...
  sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-stage2-step24k ifeval online-coding seed=1 algorithm.strategy.lr=1e-4 algorithm.max_examples=$max_ex
done

for max_ex in "${MAX_EXAMPLES[@]}"; do
  echo "OLMo3-7B-Stage2-Step24k + IFEval (online-coding, seed=1, lr=1e-5, max_examples=$max_ex)"
  sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-stage2-step24k ifeval online-coding seed=1 algorithm.strategy.lr=1e-5 algorithm.max_examples=$max_ex
done

# OLMo3-7B-Stage2-Step24k + IFEval + ICL
echo "OLMo3-7B-Stage2-Step24k + IFEval (icl, seed=1)"
sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-stage2-step24k ifeval icl algorithm.batch_size=1 seed=1
...
#       sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-stage2-step48k metamath online-coding seed=$seed algorithm.strategy.lr=$lr algorithm.max_examples=$max_ex
#     done
#   done
# done
...
#   sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-stage2-step48k metamath icl algorithm.batch_size=1 seed=$seed
# done

# # OLMo3-7B-Stage2-Step48k + MetaMath + URIAL
# echo "OLMo3-7B-Stage2-Step48k + MetaMath (urial)"
# sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-stage2-step48k metamath urial seed=1

# # OLMo3-7B-Stage2-Step48k + MetaMath + Baseline
# echo "OLMo3-7B-Stage2-Step48k + MetaMath (baseline)"
# sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-stage2-step48k metamath baseline seed=1
...
#       sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-stage2-step48k flores online-coding seed=$seed algorithm.strategy.lr=$lr algorithm.max_examples=$max_ex
#     done
#   done
# done
...
#   sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-stage2-step48k flores icl algorithm.batch_size=1 seed=$seed
# done

# # OLMo3-7B-Stage2-Step48k + FLORES + URIAL
# echo "OLMo3-7B-Stage2-Step48k + FLORES (urial)"
# sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-stage2-step48k flores urial seed=1
...
for max_ex in "${MAX_EXAMPLES[@]}"; do
  ...
  sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-stage2-step48k ifeval online-coding seed=1 algorithm.strategy.lr=1e-4 algorithm.max_examples=$max_ex
done

for max_ex in "${MAX_EXAMPLES[@]}"; do
  echo "OLMo3-7B-Stage2-Step48k + IFEval (online-coding, seed=1, lr=1e-5, max_examples=$max_ex)"
  sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-stage2-step48k ifeval online-coding seed=1 algorithm.strategy.lr=1e-5 algorithm.max_examples=$max_ex
done
...
#       sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-instruct-step200 metamath online-coding seed=$seed algorithm.strategy.lr=$lr algorithm.max_examples=$max_ex
#     done
#   done
# done
...
#   sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-instruct-step200 metamath icl algorithm.batch_size=1 seed=$seed
# done

# # OLMo3-7B-Instruct-Step200 + MetaMath + URIAL
# echo "OLMo3-7B-Instruct-Step200 + MetaMath (urial)"
# sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-instruct-step200 metamath urial seed=1

# # OLMo3-7B-Instruct-Step200 + MetaMath + Baseline
# echo "OLMo3-7B-Instruct-Step200 + MetaMath (baseline)"
# sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-instruct-step200 metamath baseline seed=1
...
#       sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-instruct-step200 flores online-coding seed=$seed algorithm.strategy.lr=$lr algorithm.max_examples=$max_ex
#     done
#   done
# done
...
#   sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-instruct-step200 flores icl algorithm.batch_size=1 seed=$seed
# done

# # OLMo3-7B-Instruct-Step200 + FLORES + URIAL
# echo "OLMo3-7B-Instruct-Step200 + FLORES (urial)"
# sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-instruct-step200 flores urial seed=1
...
for max_ex in "${MAX_EXAMPLES[@]}"; do
  ...
  sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-instruct-step200 ifeval online-coding seed=1 algorithm.strategy.lr=1e-4 algorithm.max_examples=$max_ex
done

for max_ex in "${MAX_EXAMPLES[@]}"; do
  echo "OLMo3-7B-Instruct-Step200 + IFEval (online-coding, seed=1, lr=1e-5, max_examples=$max_ex)"
  sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-instruct-step200 ifeval online-coding seed=1 algorithm.strategy.lr=1e-5 algorithm.max_examples=$max_ex
done
...
#       sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-instruct-step400 metamath online-coding seed=$seed algorithm.strategy.lr=$lr algorithm.max_examples=$max_ex
#     done
#   done
# done
...
#   sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-instruct-step400 metamath icl algorithm.batch_size=1 seed=$seed
# done

# # OLMo3-7B-Instruct-Step400 + MetaMath + URIAL
# echo "OLMo3-7B-Instruct-Step400 + MetaMath (urial)"
# sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-instruct-step400 metamath urial seed=1

# # OLMo3-7B-Instruct-Step400 + MetaMath + Baseline
# echo "OLMo3-7B-Instruct-Step400 + MetaMath (baseline)"
# sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-instruct-step400 metamath baseline seed=1
...
#       sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-instruct-step400 flores online-coding seed=$seed algorithm.strategy.lr=$lr algorithm.max_examples=$max_ex
#     done
#   done
# done
...
#   sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-instruct-step400 flores icl algorithm.batch_size=1 seed=$seed
# done

# # OLMo3-7B-Instruct-Step400 + FLORES + URIAL
# echo "OLMo3-7B-Instruct-Step400 + FLORES (urial)"
# sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-instruct-step400 flores urial seed=1
...
for max_ex in "${MAX_EXAMPLES[@]}"; do
  ...
  sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-instruct-step400 ifeval online-coding seed=1 algorithm.strategy.lr=1e-4 algorithm.max_examples=$max_ex
done

for max_ex in "${MAX_EXAMPLES[@]}"; do
  echo "OLMo3-7B-Instruct-Step400 + IFEval (online-coding, seed=1, lr=1e-5, max_examples=$max_ex)"
  sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-instruct-step400 ifeval online-coding seed=1 algorithm.strategy.lr=1e-5 algorithm.max_examples=$max_ex
done
...
#       sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-instruct-final metamath online-coding seed=$seed algorithm.strategy.lr=$lr algorithm.max_examples=$max_ex
#     done
#   done
# done
...
#   sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-instruct-final metamath icl algorithm.batch_size=1 seed=$seed
# done

# # OLMo3-7B-Instruct-Final + MetaMath + URIAL
# echo "OLMo3-7B-Instruct-Final + MetaMath (urial)"
# sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-instruct-final metamath urial seed=1

# # OLMo3-7B-Instruct-Final + MetaMath + Baseline
# echo "OLMo3-7B-Instruct-Final + MetaMath (baseline)"
# sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-instruct-final metamath baseline seed=1
...
#       sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-instruct-final flores online-coding seed=$seed algorithm.strategy.lr=$lr algorithm.max_examples=$max_ex
#     done
#   done
# done
...
#   sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-instruct-final flores icl algorithm.batch_size=1 seed=$seed
# done

# # OLMo3-7B-Instruct-Final + FLORES + URIAL
# echo "OLMo3-7B-Instruct-Final + FLORES (urial)"
# sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-7b-instruct-final flores urial seed=1
...
#       sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-1025-7b metamath online-coding seed=$seed algorithm.strategy.lr=$lr algorithm.max_examples=$max_ex
#     done
#   done
# done
...
for max_ex in "${MAX_EXAMPLES[@]}"; do
  ...
  sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-1025-7b metamath online-coding seed=1 algorithm.strategy.lr=1e-4 algorithm.max_examples=$max_ex
done

# # OLMo3-1025-7B + MetaMath + ICL
# for seed in "${SEEDS[@]}"; do
#   echo "OLMo3-1025-7B + MetaMath (icl, seed=$seed)"
#   sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-1025-7b metamath icl algorithm.batch_size=1 seed=$seed
# done

# # OLMo3-1025-7B + MetaMath + URIAL
# echo "OLMo3-1025-7B + MetaMath (urial)"
# sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-1025-7b metamath urial seed=1

# # OLMo3-1025-7B + MetaMath + Baseline
# echo "OLMo3-1025-7B + MetaMath (baseline)"
# sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-1025-7b metamath baseline seed=1
...
#       sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-1025-7b flores online-coding seed=$seed algorithm.strategy.lr=$lr algorithm.max_examples=$max_ex
#     done
#   done
# done
...
#   sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-1025-7b flores icl algorithm.batch_size=1 seed=$seed
# done

# # OLMo3-1025-7B + FLORES + URIAL
# echo "OLMo3-1025-7B + FLORES (urial)"
# sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-1025-7b flores urial seed=1
...
for max_ex in "${MAX_EXAMPLES[@]}"; do
  ...
  sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-1025-7b ifeval online-coding seed=1 algorithm.strategy.lr=1e-4 algorithm.max_examples=$max_ex
done

for max_ex in "${MAX_EXAMPLES[@]}"; do
  echo "OLMo3-1025-7B + IFEval (online-coding, seed=1, lr=1e-5, max_examples=$max_ex)"
  sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-1025-7b ifeval online-coding seed=1 algorithm.strategy.lr=1e-5 algorithm.max_examples=$max_ex
done

# OLMo3-1025-7B + IFEval + ICL
echo "OLMo3-1025-7B + IFEval (icl, seed=1)"
sbatch --gres=gpu:1 slurm/run-experiment.sh olmo3-1025-7b ifeval icl algorithm.batch_size=1 seed=1

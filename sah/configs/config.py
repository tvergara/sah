...
class Config:
    ...
    For more info, see the [instantiate_algorithm][sah.main.instantiate_algorithm] function.
    """
    ...
    See the [MNISTDataModule][sah.datamodules.image_classification.mnist.MNISTDataModule] for an example.
    """

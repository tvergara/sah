...
from sah.datamodules.datamodule_tests import DataModuleTests
from sah.datamodules.text.text_classification import TextClassificationDataModule

text_datamodule_configs = ["glue_cola"]


@pytest.mark.slow
@setup_with_overrides("datamodule=glue_cola")
class TestTextClassificationDataModule(DataModuleTests[TextClassificationDataModule]): ...
...
# )
# @pytest.mark.parametrize(datamodule.__name__, text_datamodule_configs, indirect=True)

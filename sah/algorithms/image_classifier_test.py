...
from sah.algorithms.lightning_module_tests import LightningModuleTests
from sah.configs import Config
...
from sah.datamodules.image_classification.image_classification import (
    ImageClassificationDataModule,
)
from sah.main_test import experiment_commands_to_test
from sah.utils.env_vars import SLURM_JOB_ID
from sah.utils.testutils import IN_GITHUB_CI, run_for_all_configs_of_type
...
class TestImageClassifier(LightningModuleTests[ImageClassifier]):
    ...
    - `algorithm_config` will take the value `"image_classifier"`
        - This is because there is an `image_classifier.yaml` config file in sah/configs/algorithms

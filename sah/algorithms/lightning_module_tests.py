...
See the [sah.algorithms.image_classifier_test][] module for an example of how to use this.
"""
...
from sah.conftest import DEFAULT_SEED
from sah.experiment import instantiate_trainer
from sah.main import instantiate_algorithm, setup_logging
...
class LightningModuleTests(Generic[LightningModuleType], ABC):
    ...
    See the [sah.algorithms.image_classifier_test][] module for an example.
